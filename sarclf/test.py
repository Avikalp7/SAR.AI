...
def classify_image(image_path, modified, h, clf):
    assert os.path.exists(image_path), "Error: Image path entered for clf doesn't exist"
    ...
    textures_list = list(textures.reshape(textures.shape[0] * textures.shape[1], textures.shape[2]))
